...
//      console.log('filterInitialized', this.filterInitialized)
      ...
      this.TFIs_filtered = this.TFIs.filter(tfi => this.filterInitialized && (tfi.metadata.initDate!==undefined && tfi.metadata.initDate!==null) || this.filterInitialized===false)
